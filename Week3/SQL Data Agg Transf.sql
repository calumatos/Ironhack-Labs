...
SELECT rental_date, DATE_FORMAT(rental_date, '%M') AS rental_month, DATE_FORMAT(rental_date, '%W') AS rental_weekday
FROM rental
LIMIT 20;
...
SELECT COUNT(release_year) as number_films
FROM film; 

# 1.2 The number of films for each rating.
SELECT rating, COUNT(release_year) as number_films 
FROM film 
GROUP BY rating;
